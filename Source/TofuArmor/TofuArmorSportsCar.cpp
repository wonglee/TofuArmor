...
#include "TofuArmorSportsCar.h"
#include "TofuArmorSportsWheelFront.h"
#include "TofuArmorSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATofuArmorSportsCar::ATofuArmorSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTofuArmorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTofuArmorSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTofuArmorSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTofuArmorSportsWheelRear::StaticClass();
