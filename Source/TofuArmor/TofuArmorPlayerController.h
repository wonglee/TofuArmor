...
#include "TofuArmorPlayerController.generated.h"

class UInputMappingContext;
class ATofuArmorPawn;
class UTofuArmorUI;
...
class ATofuArmorPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ATofuArmorPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ATofuArmorPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UTofuArmorUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UTofuArmorUI> VehicleUI;
