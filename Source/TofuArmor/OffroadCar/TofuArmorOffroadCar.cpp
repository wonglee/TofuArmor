...
#include "TofuArmorOffroadCar.h"
#include "TofuArmorOffroadWheelFront.h"
#include "TofuArmorOffroadWheelRear.h"
...
ATofuArmorOffroadCar::ATofuArmorOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTofuArmorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTofuArmorOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTofuArmorOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTofuArmorOffroadWheelRear::StaticClass();
